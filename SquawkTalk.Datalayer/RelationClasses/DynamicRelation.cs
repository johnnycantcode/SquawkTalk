...
namespace SquawkTalk.Datalayer.RelationClasses
{
	...
	public class DynamicRelation : DynamicRelationBase
	{
		...
		/// <param name="onClause">The on clause for the join.</param>
		public DynamicRelation(DerivedTableDefinition leftOperand, JoinHint joinType, SquawkTalk.Datalayer.EntityType rightOperand, string aliasRightOperand, IPredicate onClause)
		{
